...
export declare const ROUTING_TABLE_UPDATE_QUEUE_CONCURRENCY = 16;
export declare const ROUTING_TABLE_UPDATE_MAX_QUEUE_SIZE = 16384;
...
export declare class RoutingTable extends TypedEventEmitter<RoutingTableEvents> implements Startable {
    ...
    private readonly routingTableUpdateQueue;
