...
import { DaupP2PRegistryNode, signAppManifest, verifyAppManifestSignature } from '../src/DaupP2PRegistryNode.js';
...
describe('DaupP2PRegistryNode Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        const bootstrapAddr = addrs.find((a) => a.includes('127.0.0.1') && !a.includes('/ws'));
        if (!bootstrapAddr) {
        ...
        while (Date.now() - start < 5000) {
            if (nodeA.registry.getVerifiedPeers().length > 0 &&
